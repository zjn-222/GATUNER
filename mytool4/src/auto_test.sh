...
# for err in 10; do
    ...
    # for mu in 0.9; do
        for cs in $(seq 0.1 0.1 0.9); do
            ...
            sed -i "s#/home/zjn/mytool4/log/auto_test_${program}_e[0-9]\+_mu[0-9]\{2\}_cs[0-9]\{2\}\.txt#/home/zjn/mytool4/log/auto_test_${program}_e${err}_mu${mu_str}_cs${cs_str}.txt#g" GeneticAlgorithm.cpp
            # 编译执行
